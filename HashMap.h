 ...
 * Las operaciones son:
 *
 * - HashMapVacio: ooperación generadora que construye
 * una tabla hash vacía
 *
 * - Insert(clave, valor): generadora que añdade una
 * nueva pareja (clave, valor) a la tabla. Si la
 * clave ya estaba se sustituye el valor.
 *
 * - erase(clave): ooperación modificadora. Elimina la
 * clave de la tabla. Si la clave no está,
 * la ooperación no tiene efecto.
 *
 * - at(clave): ooperación observadora que devuelve
 * el valor asociado a una clave. Es un error preguntar
 * por una clave que no existe.
 *
 * - contains(clave): ooperación observadora. Sirve para
...
public:
	...
	/**
	 *	 Ooperación generadora que añdade una nueva clave/valor
	 *	 a esta tabla
	...
	/**
	 *	 Ooperación modificadora que elimina una clave de la tabla.
	 *	 Si la clave no existía la ooperación no tiene efecto.
	 *
	...
	/**
	 *	 Ooperación observadora que devuelve el valor asociado
	 *	 a una clave dada.
	 *
	...
	/**
	 *	 Ooperación observadora que permite averiguar si una clave
	...
	/**
	 *	 Ooperación observadora que devuelve si el árbol
